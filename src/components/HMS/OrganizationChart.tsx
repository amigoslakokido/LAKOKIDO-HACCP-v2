...
export function OrganizationChart() {
 ...
 <div className="text-xs opacity-90">HMS Manager</div>
 </div>
 </div>
 ...
 <div className="text-xs opacity-90">Team Leader</div>
 </div>
 </div>
 <div className="bg-white/10 rounded-lg p-3 space-y-1.5">
 <div className="flex items-start gap-2">
 ...
 <div className="text-xs opacity-90">Preparation Staff</div>
 </div>
 </div>
 <div className="bg-white/10 rounded-lg p-3 space-y-1.5">
 <div className="flex items-start gap-2">
 ...
 <div className="text-xs opacity-90">Delivery Drivers</div>
 </div>
 </div>
 <div className="bg-white/10 rounded-lg p-3 space-y-1.5">
 <div className="flex items-start gap-2">
